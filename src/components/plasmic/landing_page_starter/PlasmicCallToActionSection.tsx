...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: mRX-7KEjnKAI/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jzE83)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox___7QpWg)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__xJu7Z)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__im61H)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__dnBU)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
