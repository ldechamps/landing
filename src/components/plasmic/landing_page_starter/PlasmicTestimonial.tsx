...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: sqKqT-1fz402/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fbMv7)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tHqdc)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__s9Pst)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__xf8Zp)}>
            {p.renderPlasmicSlot({
