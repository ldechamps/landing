...
import sty from "./PlasmicPriceCard.module.css"; // plasmic-import: jy5YgdaxU1zx/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__rcQry)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__pe01O)}>
          <div className={classNames(projectcss.all, sty.freeBox__bWvP6)}>
            {p.renderPlasmicSlot({
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ps7CC)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__rlp8F)}>
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__k2Zub)}>
              {p.renderPlasmicSlot({
                defaultContents: "8",
                value: args.dollars,
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__nEeCp)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__xUjt9)}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__chjY)}
                  description={
                    "Vestibulum mollis odio dictum ultrices facilisis molestie vestibulum"
                  }
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__z9U3P)}
                      role={"img"}
                    />
                  }
                />
                ...
                <ValueProp
                  className={classNames("__wab_instance", sty.valueProp__wQpJf)}
                  description={"Mus consequat a justo"}
                  icon={
                    <CheckIcon
                      className={classNames(projectcss.all, sty.svg__lhE6M)}
                      role={"img"}
                    />
                  }
                />
