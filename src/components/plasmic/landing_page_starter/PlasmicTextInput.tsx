...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: P82FRSoypaDA/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchIcon
              className={classNames(projectcss.all, sty.svg__n7RMi)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <CheckIcon
              className={classNames(projectcss.all, sty.svg__pgUrW)}
              role={"img"}
            />
          ),
